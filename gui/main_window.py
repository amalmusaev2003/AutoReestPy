...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.select_folder_button.setGeometry(50, 50, 300, 50)
        ...
        self.process_button.setGeometry(50, 200, 100, 30)
